...
export VSPHERE_SSH_PRIVATE_KEY="/Users/geetika.b/.ssh/id_rsa"
...
# docker run --rm -d --name vpn -v "${PWD}/.openvpn/:${PWD}/.openvpn/" \
#   -w "${PWD}/.openvpn/" --cap-add=NET_ADMIN --net=host --device=/dev/net/tun \
